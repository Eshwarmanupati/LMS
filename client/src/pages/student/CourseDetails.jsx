      ...
      <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 pt-20 text-left'>
        ...
        <div className='absolute top-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b from-cyan-100/70'> </div>
          ...
          <div className='max-w-xl z-10 text-gray-500'>
            <h1 className='md:text-course-details-heading-large text-course-details-hading-small font-semibold text-gray-800'>{courseData.courseTitle}</h1>
          ...
          <div className='py-20 ext-sm md:ext-default'>
          ...
          {/*  right column */}
          <div className='max-w-[424px] shadow-[0px_4px_15px_2px_rgba(0,0,0,0.1)] rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px] z-10]'>
            ...
            <div className='p-5'>
              <div className='flex items-center gap-2'>
                ...
                <p className='text-red-500'><span>5 days</span> left at the prize</p>
              </div>
